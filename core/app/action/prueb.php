                                ...
                                <table class='table' style="margin:0px;">
                                    <tr>
                                        ...
                                        <td style="padding:0px; border: 0;" >
                                            <!--span class="glyphicon glyphicon-phone" style="color:#936ce1;margin-right: 2px;"></span><a style="color: #936ce1" href="tel:+54<?php echo $cliente->telefono;?>"> <?php echo $cliente->telefono."|";?> </a!-->
                                            <a href="tel:+54<?php echo $cliente->telefono;?>"  style="cursor:pointer"  class="btn btn-warning btn-xs "  >
                                        ...
                                        <td  style="padding:0px; border: 0;text-align: right"  id="_<?php echo $cliente->id_cliente; ?>">



                                            <a href="<?php echo clsFunciones::whatsapp("Hola buenas, soy del servicio tecnico",$cliente->telefono); ?>"  target="_blank"  style="margin-right:3px;cursor:pointer;"  class="btn btn-success btn-sm " data-toggle="tooltip" data-placement="bottom" title="Iniciar chat" >
                                            ...
                                            <a href="index.php?view=st_EditarCliente&cliente=<?php echo $cliente->id_cliente; ?>"  style="margin-right:3px;cursor:pointer"  class="btn btn-primary btn-sm acciones btnTop_espacio"  data-toggle="tooltip" data-placement="bottom" title="Editar cliente">
                                                <span class="glyphicon glyphicon-pencil" ></span>
                                            </a>



                                            <a    href="./?view=st_imprimir&cliente=<?php echo $cliente->id_cliente; ?>"  style="margin-right:3px;"  class="btn btn-success btn-sm acciones btnTop_espacio"  >
                                    ...
                                    while ($row2 = mysqli_fetch_assoc($res2[0])) {
                                        ...
                                        if($row2["id_estado"]!=5){
                                            ...
                                            <tr  style="<?php if($cant==1){ echo "height:108px;";} if($i==$cant-1){echo "height:108px;";} if($buscaOrden==$row2["nr_orden"]){echo ";color:#42ca8c;";}  ?>" >
                                                ...
                                                <td  style=" text-align: right; <?php if($linea==0){echo "border: 0;";} ?>" id="<?php echo $cliente->id_cliente."#".$row2["nr_orden"];  ?>">
                                                    <table>
                                                        <tr >
                                                            <td>
                                                                <!-- Editar y Reingreso -->
                                                            ...
                                                            <td>
                                                                <a  href="index.php?view=vincularBarCode&equipo=<?php echo $row2["nr_orden"]; ?>" style="margin-right:5px;cursor:pointer" class="btn btn-primary btn-sm acciones btnTop_espacio" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Vincular BarCode">
                                            ...
                                            if($E_entregados==1){
                                                ...
                                                <tr  style="<?php if($cant==1){ echo "height:108px;";} if($i==$cant-1){echo "height:108px;";} if($buscaOrden==$row2["nr_orden"]){echo ";color:#42ca8c;";}  ?>" >
                                                    ...
                                                    <td  style="<?php if($linea==0){echo "border:0;";} ?> ;text-align: right; " id="<?php echo $cliente->id_cliente."#".$row2["nr_orden"];  ?>">
                                                        <table>
                                                            <tr >
                                                                <td>
                                                                    <!-- Editar y Reingreso -->
